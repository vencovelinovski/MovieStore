        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DirectorName = table.Column<string>(maxLength: 150, nullable: true),
                    DirectroId = table.Column<string>(nullable: true),
                    DirectorId = table.Column<int>(nullable: true),
                    ProdusentName = table.Column<string>(maxLength: 150, nullable: true),
                    ProdusentId = table.Column<string>(nullable: true),
                    ProdusentId1 = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_Actors_ActorId1",
                        column: x => x.ActorId1,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Movies_Produsers_ProdusentId1",
                        column: x => x.ProdusentId1,
